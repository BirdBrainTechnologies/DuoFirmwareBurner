...
codesign -f -s "3rd Party Mac Developer Application: Tom Lauwers" --entitlements Mac/supportFiles/entitlementsInherit.plist Mac/supportFiles/Hummingbird\ Firmware\ Burner.app/Contents/Java/avrdude_mac -vvvv
codesign -f -s "3rd Party Mac Developer Application: Tom Lauwers" --entitlements Mac/supportFiles/entitlementsInherit.plist Mac/supportFiles/Hummingbird\ Firmware\ Burner.app/Contents/PlugIns/Java.runtime/Contents/Home/lib/jspawnhelper -vvvv
codesign -f -s "3rd Party Mac Developer Application: Tom Lauwers" --entitlements Mac/supportFiles/entitlementsInherit.plist Mac/supportFiles/Hummingbird\ Firmware\ Burner.app/Contents/PlugIns/Java.runtime -vvvv
codesign -f -s "3rd Party Mac Developer Application: Tom Lauwers" --entitlements Mac/supportFiles/entitlements.plist Mac/supportFiles/Hummingbird\ Firmware\ Burner.app/ -vvvv
...
# Need to sign the app with the other certificate?
